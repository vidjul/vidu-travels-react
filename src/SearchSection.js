                    ...
                    <div className="columns">
                        <div className="column is-one-quarter">
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                    <input type="date" name="inboundDate" className={classnames('input', {'is-danger': errors.find(err => err.ParameterName === 'InboundDate')})} value={this.state.searchQuery.inboundDate} onChange={this.handleChange} />
                                </div>
